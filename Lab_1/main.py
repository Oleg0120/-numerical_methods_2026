...
# -------------------------------
# 1. ЗАПИТ ДО OPEN-ELEVATION API (ПУНКТ 1)
# -------------------------------
...
# --------------------------
# 2. ТАБУЛЯЦІЯ ВУЗЛІВ ТА ЗАПИС У ФАЙЛ (ПУНКТИ 3, 4)
# ---------------------------
n = len(results)
...
# ------------------------
# 6. ХАРАКТЕРИСТИКИ МАРШРУТУ (ДОДАТКОВО)
# ------------------------
print("\n" + "="*60)
...
# ----------------------
# 7. ДОДАТКОВІ ГРАФІКИ: ГРАДІЄНТ ТА ЕНЕРГІЯ
# -----------------------
plt.figure(figsize=(10, 4))
